...
<head>
    ...
    <title>RETROO OYUN | Yönetim Paneli</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="../ytpanel">RETROO OYUN | E-Ticaret Yönetim Paneli</a>
            ...
            <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
                ...
                <hr />
                <h6 class="text-center"> Alper BİLGİN</h6>
            </div>
        </div>
    </nav>
...
<script>
    ...
    document.getElementById('yil').textContent = "Copyright © Alper Bilgin 2024 - " + yil;
</script>