...
<body>
    ...
    <div class="container"><p class="m-0 text-center text-white" id="yil">Copyright © ALPER BİLGİN </p></div>
    </footer>
</body>
</html>
...
<script>
    ...
    document.getElementById('yil').textContent = "Copyright © ALPER BİLGİN 2024 - " + yil;
</script>